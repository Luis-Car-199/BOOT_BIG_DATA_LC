...
#Esta grafica se usa con una seleccion de oclumnas como X(que son las variables n que influyen en la y e y más el modelo. Pueden representar cualquier grafica de grado 1
